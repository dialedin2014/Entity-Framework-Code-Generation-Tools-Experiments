...
/// Jsrsoft, June 2013
/// CGrace, updated to latest EF 5.2 on 3/27/2018
/// </summary>
///  ****************************************************************************

using Microsoft.CSharp;
using Microsoft.Data.Entity.Design.Templates;
using System;
...
namespace EF.Utility.CS.FromTTinclude.CodeGenerationTools
{
    ...
    public class CodeGenerationTools
    {
        ...
        public static string GetResourceString(string resourceName, CultureInfo culture = null)
        {
            ...
            {
                _resourceManager = TemplateResources.ResourceManager;
            }
